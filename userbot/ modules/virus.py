...
async def typewriter(typew):
	...
	await typew.edit(str(number) + "%   ████████████████▌")
	sleep(1)
	await typew.edit("`Korban Berhasil Dikirim Virus Malware!`")
	sleep(5)
	await typew.edit("`Tapi Boong, Wkwkwkwk!`")
